...
<script>
    ...
    export default{
        ...
        methods:{
             ...
             //商品信息初始化
            scrollInfo() {
                this.$post('http://www.bjytzh.cn/jxc/showOfficial.thtml?id=' + this.$route.query.id).then(res => {
            ...
            onSubmit() {
                ...
                this.$post('http://www.bjytzh.cn/jxc/updateOfficialCarousel.thtml',qs.stringify(this.form)).then(res => {
                    if(res == 1) {
                        this.$message({
                            message: "修改成功",
                            type: 'success'
